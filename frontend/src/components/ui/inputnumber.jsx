...
function InputNumberInput({
    ...
    return (
        <PRInputNumber.Input
            className={cn(inputTextVariants({ size, variant }), 'peer flex-auto', // layout
            'in-data-[layout=stacked]:pe-9 in-data-[layout=vertical]:px-1!', 'in-data-[layout=horizontal]:rounded-none in-data-[layout=horizontal]:order-2', 'in-data-[layout=vertical]:rounded-none in-data-[layout=vertical]:order-2 in-data-[layout=vertical]:text-center in-data-[layout=vertical]:w-full', // fluid
            'in-data-fluid:w-[1%]', 'in-data-fluid:in-data-[layout=vertical]:w-full', className)}
            {...props} />
    );
}
...
export { InputNumber, InputNumberDecrement, InputNumberGroup, InputNumberIncrement, InputNumberInput };
