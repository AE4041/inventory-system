...
function DialogContent({
    ...
    return (
        <PRDialog.Content
            className={cn('overflow-y-auto pt-0 px-4.5 pb-4.5 data-maximized:grow', className)}
            {...props} />
    );
}
...
function DialogHeader({
    ...
    return (
        <PRDialog.Header
            className={cn('flex items-center justify-between shrink-0 p-4.5', className)}
            {...props} />
    );
}
...
function DialogFooter({
    ...
    return (
        <PRDialog.Footer
            className={cn('shrink-0 pt-0 px-4.5 pb-4.5 flex justify-end gap-1.5', className)}
            {...props} />
    );
}
